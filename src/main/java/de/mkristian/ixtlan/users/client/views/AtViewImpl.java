...
import de.mkristian.ixtlan.users.client.editors.AtQueryEditor;
import de.mkristian.ixtlan.users.client.editors.UserEditor;
import de.mkristian.ixtlan.users.client.editors.UserEditor.Display;
...
import de.mkristian.ixtlan.users.client.places.AtPlaceTokenizer;
import de.mkristian.ixtlan.users.client.places.UserPlace;
import de.mkristian.ixtlan.users.client.places.UserPlaceTokenizer;
...
public class AtViewImpl extends Composite implements AtView {
    ...
    @Inject
    public AtViewImpl(UserCache cache, SessionManager<User> session) {
